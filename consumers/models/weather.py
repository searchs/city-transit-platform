...
class Weather(Producer):
    ...
    def run(self, month):
        ...
        logger.info("weather kafka proxy integration - Emitting Weather messages")
        data = {
        ...
        resp = requests.post(
            ...
            #  v3 of Rest Proxy now allows application/json
        ...
        try:
            ...
            logger.info(
                f"Failed to send data to the REST Proxy {json.dumps(resp.json(), indent=4)}"
            )
